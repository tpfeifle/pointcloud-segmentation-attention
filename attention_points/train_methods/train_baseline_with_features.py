...
N_VAL_SAMPLES = 4542
BATCH_SIZE = 16
LOG_DIR = os.path.join('/home/tim/training_log/baseline/features_%s' % int(time.time()))

class_weights = tf.constant([0.0, 2.743064592944318, 3.0830506790927132, 4.785754459526457, 4.9963745147506184,
