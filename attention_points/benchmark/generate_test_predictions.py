...
def train(batch_size=BATCH_SIZE):
    ...
    current_scene = ""
    while True:
        predictions_res_temp, points_res, scene, thefeatures, colorres, pointerres_orig, maskerrades = sess.run(
            [val_pred, val_coordinates, scene_name, val_features, colors, points_orig_idxs, mask])
