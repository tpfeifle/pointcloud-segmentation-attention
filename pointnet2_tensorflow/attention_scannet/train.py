...
LOG_DIR = os.path.join('/tmp/pycharm_project_250/pointnet2_tensorflow/log/%s' % int(time.time()))  # FLAGS.log_dir
...
TEST_DATASET_WHOLE_SCENE = scannet_dataset.ScannetDatasetWholeScene(root=DATA_PATH, npoints=NUM_POINT, split='train')
